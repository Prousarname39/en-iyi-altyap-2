...
client.on("guildCreate", async guild => {
  guild.owner.send("Selamın Aleykum Kullanıcım Beni Ekledigin İçin Teşekkürler Bi Sorun Olursa Destek Sunucuma Beklerim https://discord.gg/6h8XQW3pCp < 3");
});
//////////////////////////////
client.on("guildDelete", async guild => {
  guild.owner.send("Selamün aleyküm, Değerli kullanıcımız Botumuzu sunucudan atma nedeninizi destek sunucumuzdan bildirmenizi rica ediyoruz.  Hatamız varsa bilelim ki düzeltelim. https://discord.gg/6h8XQW3pCp");
});
...
if(!msg.guild) return
    ...
    .setColor("RANDOM")
    .setDescription(`<:dev:726038280725987389> **• Prefixim c!**  \n **\<:dev:726038280725987389> • c!yardım yazarak komutlarımı kategorileriyle görebilirsin.**`)
...
client.on("message", msg => {
var dm = client.channels.cache.get("726038280725987389")
